...
const state_target = "  const [isGenerating, setIsGenerating] = useState(false);";
const state_replacement = "  const [isGenerating, setIsGenerating] = useState(false);\n  const [testUrl, setTestUrl] = useState('');\n  const [csvFile, setCsvFile] = useState(null);\n  const [showLegacyOptions, setShowLegacyOptions] = useState(false);";
...
const ui_target = /<h4 className="mt-2 text-accent">Option 1: Generate from Topic<\/h4>[\s\S]*?<button type="submit" className="btn-outline mt-2">Publish Manually \(Legacy\)<\/button>/m;
const ui_replacement = <h4 className="mt-2 text-accent" style={{ color: '#4CAF50' }}>Option 1: Embed a Test Link (Google Forms, etc.)</h4>
...
console.log("Patch applied to admin-dashboard/page.js");
